...
struct ArgWrapper {
  ...
  ArgWrapper(ArgWrapper &&o)
      : arg1(std::move(o.arg1)), arg2(std::move(o.arg2)),
        arg3(std::move(o.arg3)) {}
  template <typename T, typename U, typename V>
  ArgWrapper(T &&a1, U &&a2, V &&a3)
      : arg1(std::forward<T>(a1)), arg2(std::forward<U>(a2)),
        arg3(std::forward<V>(a3)) {}
  template <typename TCallback> void callCallback(TCallback &&callback) const {
...
template <typename TArg1> struct ArgWrapper<TArg1, void, void> {
  typename std::remove_reference<TArg1>::type arg1;
  ArgWrapper(ArgWrapper const &o) : arg1(o.arg1) {}
  ArgWrapper(ArgWrapper &&o) : arg1(std::move(o.arg1)) {}
  template <typename T> ArgWrapper(T &&a1) : arg1(std::forward<T>(a1)) {}
  template <typename TCallback> void callCallback(TCallback &&callback) const {
...
private:
  ...
  template <typename TCallback, typename TArgs> struct CallbackWrapper {
    template <typename U>
...
public:
  template <typename TCallback> explicit SimpleThread(TCallback &&callback) {
  ...
  explicit SimpleThread(TCallback &&callback, TArg1 &&arg1) {
    ...
    startThread(wrapper,
                &CallbackWrapper<TCallback,
                                 ::details::ArgWrapper<TArg1>>::callAndDelete);
  }
  ...
  explicit SimpleThread(TCallback &&callback, TArg1 &&arg1, TArg2 &&arg2,
    ...
    startThread(wrapper,
                &CallbackWrapper<
                    TCallback,
                    ::details::ArgWrapper<TArg1, TArg2, TArg3>>::callAndDelete);
  }
